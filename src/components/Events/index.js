...
class Event extends Component {
  state = {registrationStatus: registrationConstant.initial, isClicked: false}

  onClickEventItem = registrationStatus => {
    this.setState({registrationStatus, isClicked: true})
  }

  render() {
    const {registrationStatus, isClicked} = this.state
